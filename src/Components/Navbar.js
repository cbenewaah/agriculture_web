    ...
    <div>
        <div className='bg-customGreen flex flex-row justify-between border-4 rounded-2xl'>
            ...
            <div className='text-white my-6'>
                <a className='mx-4' href='#about'> About Us</a>
                <a className='mx-4' href='#our-story'>Our Story</a>
                <a className='mx-4' href='#our-harvest'>Our Harvest</a>
                <a className='mx-4' href='#benefits'> Benefits</a>
                <a className='mx-4' href='#reviews'> Reviews</a>
                <a className='mx-4' href='#contact-us'>Contact Us</a>
            </div>
            <div className='my-7'>
